    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="role-card text-center">
                    <h2>Writer</h2>
                    <img src="images/pompom writer.jpg" class="img-fluid">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="role-card text-center">
                    <h2>Admin</h2>
                    <img src="images/pompom admin.png" class="img-fluid">
        ...
        <div class="articles-section mt-4">
            ...
            <div class="article-icon-container text-center my-3">
                ...
                <img src="images/pompom icon.png" alt="Article Icon" class="article-icon">
                <span class="line"></span>
            </div>
